...
import ShowComments from "../../components/author.component/ShowComments";
const SubmissionsWithDecisionTable = ({ manuscript }) => {
        ...
        <Card sx={{ mt: "75px", mx: "10px", p: "10px" }} elevation={3}>
            ...
            >
                ...
                <ShowComments
                    ...
                    editorComments={manuscript.commentsFromEditor}
                    reviewerComments={manuscript.commentsFromReviewer}
                />
            </Box>
            {showAbstract && (
                <Card
...
const SubmissionsWithDecision = () => {
    const { user } = useContext(UserContext);

    const [manuscripts, setManuscripts] = useState([]);
    useEffect(() => {
        axios
            .get(`http://localhost:8000/author/submissions-with-decision/${user.authorId}`)
            .then((res) => {
        ...
        <div>
            {manuscripts.length > 0 ? (
                manuscripts.map((manuscript, index) => (
                    < SubmissionsWithDecisionTable key={index} manuscript={manuscript} />
                ))
            ) : (
                <Box align="center">
                    <Alert
                    ...
                    >
                        <AlertTitle>Not Found any submissions with decision</AlertTitle>
                        You have no Submissions with Decisions decision.
                    </Alert>
                    <RouterLink
                        to="/Author/main"
...
export default SubmissionsWithDecision;
