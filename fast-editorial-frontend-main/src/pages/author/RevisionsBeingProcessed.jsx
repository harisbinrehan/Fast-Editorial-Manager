...
const RevisionsBeingProcessedTable = ({ manuscript }) => {
...
const RevisionsBeingProcessed = () => {
    const { user } = useContext(UserContext);
    // Replace this object with the actual data fetched from the API
    const [manuscripts, setManuscripts] = useState([]);
    useEffect(() => {
        axios
            .get(`http://localhost:8000/author/revisions-being-processed/${user.authorId}`)
            .then((res) => {
        ...
        <div>
            {manuscripts.length > 0 ? (
                manuscripts.map((manuscript, index) => (
                    < RevisionsBeingProcessedTable key={index} manuscript={manuscript} />
                ))
            ) : (
                <Box align="center">
                    <Alert
                    ...
                    >
                        <AlertTitle>No Revisions Being Processed</AlertTitle>
                        You have no manuscripts that are being processed.
                    </Alert>
                    <RouterLink
                        to="/Author/main"
...
export default RevisionsBeingProcessed;
