...
const CompletedSubmissionsTable = ({ manuscript }) => {
...
const CompletedSubmissions = () => {
    ...
    useEffect(() => {
        axios
            .get(`http://localhost:8000/author/completed-submissions/${user.authorId}`)
            .then((res) => {
                setManuscripts(res.data.manuscripts);
                console.log(res.data.manuscripts);
            })
            .catch((err) => {
                console.log(err);
            });
        ...
        <div>
            {manuscripts.length > 0 ? (
                manuscripts.map((manuscript, index) => (
                    < CompletedSubmissionsTable key={index} manuscript={manuscript} />
                ))
            ) : (
                <Box align="center">
                    <Alert
