...
import { Box, Button, TextField, Typography, Grid, Avatar, Divider, IconButton, List, ListItem, ListItemIcon, ListItemText, useMediaQuery, useTheme } from "@mui/material";
...
const EditProfileEditor = () => {
    ...
    useEffect(() => {
        const fetchUser = async () => {
            try {
                const response = await axios.get(`http://localhost:8000/editor/current-user/${user._id}`);
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await axios.put(`http://localhost:8000/editor/edit-profile/${user.editorId}`, formData);
